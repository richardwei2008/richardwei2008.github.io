...
Nehan.Book.Model.PageStream = Backbone.Model.extend({
    ...
    getPage : function(page_no){
        return this.document.getPage(page_no);
    },
    ...
    asyncGet : function(callback){
        ...
        this.document.render({
            ...
            onComplete : function(time, ctx){
                ...
                self.outlineElement = self.document.createOutlineElement({
